...
namespace MyProductStore.Products.ClientProxies;
...
{
    public virtual async Task<List<ProductDto>> GetProductsByAvailabilityAsync(bool isAvailable)
    {
        return await RequestAsync<List<ProductDto>>(nameof(GetProductsByAvailabilityAsync), new ClientProxyRequestTypeValue
        {
            { typeof(bool), isAvailable }
        });
    }
